  ...
  return (
    <Box id="contact" pt={["2rem", "3rem", "5rem", "10rem"]} bg={style.app_bg_gradient} boxShadow={style.box_shadow_blur_form}>
      ...
      >
        ...
        <Flex justifyContent={"center"} wrap="wrap" gap={["1rem", "2rem", "3rem", "4rem"]} pt="1.5rem">
          {/* contact details */}
          {/* ----------------------- */}
          <Flex justifyContent={"center"} flexDir={"column"} alignItems={"center"} flexWrap={"wrap"} gap="1rem" >
            ...
            <Flex flexDir={"column"} justifyContent={"center"} borderRadius={"md"} w={["max-content", "max-content", "14rem", "14rem"]} h="max-content" p="3rem" className='contact-btn' >
              ...
              <Text id="contact-phone">+91 8745983389</Text>
              <a href="https://api.whatsapp.com/send?phone=+918745983389" target="_blank">Send a message</a>
            </Flex>
            <Flex flexDir={"column"} justifyContent={"center"} borderRadius={"md"} w={["max-content", "max-content", "14rem", "14rem"]} h="max-content" p="3rem" className='contact-btn' >
              <AiOutlineMail size={"3rem"} />
              <Text p={"10px 0"} textTransform={"uppercase"} color="orange">Email</Text>
              <Text id="contact-email">rkrahul8181@gmail.com</Text>
              <a href="https://api.whatsapp.com/send?phone=+918745983389" target="_blank">Send an email</a>
            </Flex>
          </Flex>
          <Box pl={{ md: "2rem" }}>
