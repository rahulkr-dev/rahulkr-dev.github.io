...
import { Heading, Box, Flex, Text, Button, Center } from "@chakra-ui/react";
import "./project.css";
import {
  zee5,
  lifeStyle,
  ...
  return (
    <Box mb="4rem" p="1rem" id="projects">
      <Heading
        ...
        p={["1rem", "1rem", "1rem 3rem", "1rem 6rem"]}
      >
        My PROJECTS
      </Heading>
      <Flex
        mb={["2em", "3rem", "3rem", "4rem"]}
        fontFamily={"cursive"}
      ...
      >
        <Text
          ...
          className={`btn ${active == "all" ? "btn-active-project" : ""}`}
        >
          ALL
        </Text>
        <Text
          onClick={() => setActive("react")}
          className={`btn ${active == "react" ? "btn-active-project" : ""}`}
        >
          REACT
        </Text>
        <Text
          onClick={() => setActive("mern")}
          className={`btn ${active == "mern" ? "btn-active-project" : ""}`}
        >
          MERN
        </Text>
        <Text
          ...
          className={`btn ${
            active == "javascript" ? "btn-active-project" : ""
          }`}
        >
          JAVASCRIPT
        </Text>
