...
const Header = () => {
  return (
    <Box h={{lg:"100vh"}} bg="#2596be" p={['1rem', '2rem', '3rem']} >
      <Hamburger />
      <Box >
        ...
        <Grid mt="1rem" templateColumns={["repeat(1,1fr)", "repeat(1,1fr)", "repeat(2,1fr)"]} >
          ...
          <Grid m={["3rem 0 2rem 0"]} justifyContent="center" alignItems="center" color="#fff" >
            ...
            <a style={{border:"1px solid yellow",color:"black",margin:"1rem 0"}} href="#contact" className='btn btn-primary'>Let's Talk</a>
          </Grid>
